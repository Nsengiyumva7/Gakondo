...
import {  FaCalendar, FaHotel, FaUserAlt } from 'react-icons/fa';
...
const Dashboard = () => {
  ...
  const adminName = adminInfo ? adminInfo.adminName : ''; // Add this line to handle the null case

  return (
    <div className='d-container'>
      <div className="d-row">
      <h1 className="d-title">Welcome {adminName}</h1> {/* Use adminName instead of adminInfo.adminName */}
      </div>
      <div className="d-row">
